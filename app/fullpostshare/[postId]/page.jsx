    ...
    const [userData, setUserData] = useState({});
      ...
      useEffect(() => {
        const fetchPostByUser = async () => {
            try {
                ...
                const response = await axios.get(`https://localhost:5001/project/getProjectByUserId/${id}`, { withCredentials: true });
      ...
      useEffect(() => {
        const fetchUserData = async () => {
          try {
            const response = await axios.get(`https://localhost:5001/project/getUserById/${id}`);
