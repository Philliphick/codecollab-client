...
export const Dashboard = ({ user }) => {
  ...
  useEffect(() => {
    ...
    const fetchPosts = async () => {
      try {
        ...
        const response = await axios.get('https://codecollab-server-jva6.onrender.com/project', { withCredentials: true });
    ...
    const fetchCurrentUserPosts = async () => {
      try {
        ...
        const response = await axios.get(`https://codecollab-server-jva6.onrender.com/project/getProjectByUserId/${userId}`, { withCredentials: true });
  ...
  useEffect(() => {
    const fetchAllUsers = async () => {
      try {
        const response = await axios.get('https://codecollab-server-jva6.onrender.com/project/allusers', { withCredentials: true });
